...
</script></1e-8?t-t*t></1e-6?t+t*t></22025.465794806718||-2e-17!=e(-2e-17)?function></a;){if(y></0?"-":n></n;i++)e[i]="a["+i+"]";c[n]=function("f,a","return></2)for(;;){if(h></c&&c<a+s&&(l=-1,a+=s-1,c+=s-1);s--></r.length;o++)s(r[o]);return>